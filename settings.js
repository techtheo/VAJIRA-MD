...
global.owner = process.env.OWNER_NUMBER  || '2349134983467' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=CBlVVJ4Y#StE1YAdM8kKFMRjhNh9SSipPtpDrTM1C9NwxOEOkrRU' ,
